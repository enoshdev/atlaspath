			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: /* @__PURE__ */ jsxs("div", {
							className: "w-full max-w-full sm:max-w-[340px] bg-white border border-slate-200/80 rounded-2xl sm:rounded-3xl p-4 sm:p-5 shadow-xl shadow-slate-200/40 relative overflow-hidden transition-all duration-300",
							children: [
								/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: GOALS.map((goal) => {
							...
							return /* @__PURE__ */ jsxs("button", {
								...
								className: `group relative text-left p-4 sm:p-5 rounded-2xl border bg-white transition-all duration-300 hover:-translate-y-0.5 cursor-pointer flex flex-col justify-between min-h-[180px] sm:h-[220px] overflow-hidden ${isSelected ? "border-primary ring-2 ring-primary/10 shadow-lg shadow-primary/5 bg-primary/[0.01]" : "border-slate-200/80 shadow-xs hover:border-slate-300 hover:shadow-md"}`,
								children: [
