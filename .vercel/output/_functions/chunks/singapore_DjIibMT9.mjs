...
//#region src/pages/countries/singapore.astro
var singapore_exports = /* @__PURE__ */ __exportAll({
	default: () => $$Singapore,
	file: () => $$file,
	url: () => $$url
});
var $$Singapore = createComponent(($$result, $$props, $$slots) => {
	return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {
		"title": "Study in Singapore | AtlasPath — Find Your Dream Singaporean University",
		"description": "Discover top ranked universities in Singapore, compare tuition costs, post-study work rights, living costs, and ASEAN scholarships."
...
}, "C:/Users/enosh/OneDrive/Documents/atlaspath/src/pages/countries/singapore.astro", void 0);
var $$file = "C:/Users/enosh/OneDrive/Documents/atlaspath/src/pages/countries/singapore.astro";
var $$url = "/countries/singapore";
//#endregion
//#region \0virtual:astro:page:src/pages/countries/singapore@_@astro
var page = () => singapore_exports;
//#endregion
export { page };
