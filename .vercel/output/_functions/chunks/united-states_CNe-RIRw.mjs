...
//#region src/pages/countries/united-states.astro
var united_states_exports = /* @__PURE__ */ __exportAll({
	default: () => $$UnitedStates,
	file: () => $$file,
	url: () => $$url
});
var $$UnitedStates = createComponent(($$result, $$props, $$slots) => {
	return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {
		"title": "Study in the United States | AtlasPath — Find Your Dream US University",
		"description": "Discover top research universities and Ivy League colleges in the US, compare tuition fees, STEM OPT work permits, living costs, and scholarships like Fulbright."
...
}, "C:/Users/enosh/OneDrive/Documents/atlaspath/src/pages/countries/united-states.astro", void 0);
var $$file = "C:/Users/enosh/OneDrive/Documents/atlaspath/src/pages/countries/united-states.astro";
var $$url = "/countries/united-states";
//#endregion
//#region \0virtual:astro:page:src/pages/countries/united-states@_@astro
var page = () => united_states_exports;
//#endregion
export { page };
