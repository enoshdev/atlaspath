...
import { ArrowRight, Award, Calculator, Calendar, Check, CheckCircle, ClipboardCheck, ClipboardList, Compass, Download, Globe, GraduationCap, MapPin, RefreshCw, Search, ShieldCheck, Sparkles, Star, UserCheck, Users2 } from "lucide-react";
		...
		children: /* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs(motion.div, {
						...
						children: [
							/* @__PURE__ */ jsx(motion.div, {
								...
								className: "inline-flex items-center gap-1.5 self-start mb-7",
								children: /* @__PURE__ */ jsxs("div", {
									className: "flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-[#6D4AFF]/8 border border-[#6D4AFF]/15",
									children: [/* @__PURE__ */ jsx(Star, { className: "w-3 h-3 text-[#6D4AFF] fill-[#6D4AFF]" }), /* @__PURE__ */ jsx("span", {
										className: "text-[11px] font-semibold text-[#6D4AFF] tracking-wide",
							...
							/* @__PURE__ */ jsx(motion.div, {
								...
								children: [
									...
									className: "text-[20px] font-extrabold text-[#0F172A] leading-none",
									children: s.value
								}), /* @__PURE__ */ jsx("div", {
									className: "text-[10px] font-medium text-[#64748B] mt-1 leading-tight",
									children: s.label
								})] }, s.label))
							})
						]
					...
					/* @__PURE__ */ jsxs("div", {
						className: "flex flex-col justify-center gap-3 py-12",
						children: [
							/* @__PURE__ */ jsxs(motion.div, {
								...
								children: [
									...
									/* @__PURE__ */ jsx("div", {
										...
										children: [
											...
											children: [/* @__PURE__ */ jsxs("div", {
												...
												className: "text-[11px] font-bold text-[#6D4AFF]",
												children: item.match
											})]
										}, item.country))
									}),
									/* @__PURE__ */ jsxs("a", {
										href: "#assessment",
										className: "flex items-center gap-1 mt-3 text-[10px] font-bold text-[#6D4AFF] hover:underline",
										children: ["View All ", /* @__PURE__ */ jsx(ArrowRight, { className: "w-2.5 h-2.5" })]
									})
								]
							}),
							/* @__PURE__ */ jsxs(motion.div, {
								...
								children: [
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("div", {
											className: "w-7 h-7 rounded-lg bg-violet-50 flex items-center justify-center flex-shrink-0",
											children: /* @__PURE__ */ jsx(GraduationCap, { className: "w-3.5 h-3.5 text-violet-600" })
										}), /* @__PURE__ */ jsx("span", {
									...
									/* @__PURE__ */ jsx("p", {
										className: "text-[24px] font-extrabold text-violet-600 leading-tight",
										children: "₹15 Lakhs"
									}),
									/* @__PURE__ */ jsx("p", {
									...
									/* @__PURE__ */ jsxs("a", {
										...
										children: ["View Scholarships ", /* @__PURE__ */ jsx(ArrowRight, { className: "w-2.5 h-2.5" })]
									})
								]
							}),
							/* @__PURE__ */ jsxs(motion.div, {
								...
								children: [
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("div", {
											...
											children: /* @__PURE__ */ jsx(CheckCircle, { className: "w-3.5 h-3.5 text-emerald-600" })
										}), /* @__PURE__ */ jsx("span", {
											className: "text-[11px] font-bold text-[#0F172A]",
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", { children: [
							...
							children: [/* @__PURE__ */ jsx("button", {
								...
								children: [/* @__PURE__ */ jsx("span", { children: "Book Consultation" }), /* @__PURE__ */ jsx(Check, { className: "w-3.5 h-3.5" })]
							})]
						})]
					}), /* @__PURE__ */ jsxs("div", {
