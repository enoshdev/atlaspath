...
//#region src/pages/countries/netherlands.astro
var netherlands_exports = /* @__PURE__ */ __exportAll({
	default: () => $$Netherlands,
	file: () => $$file,
	url: () => $$url
});
var $$Netherlands = createComponent(($$result, $$props, $$slots) => {
	return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {
		"title": "Study in the Netherlands | AtlasPath — Find Your Dream Dutch University",
		"description": "Discover top English-taught programs in the Netherlands, compare tuition costs, zoekjaar orientation year work permits, and scholarships."
...
}, "C:/Users/enosh/OneDrive/Documents/atlaspath/src/pages/countries/netherlands.astro", void 0);
var $$file = "C:/Users/enosh/OneDrive/Documents/atlaspath/src/pages/countries/netherlands.astro";
var $$url = "/countries/netherlands";
//#endregion
//#region \0virtual:astro:page:src/pages/countries/netherlands@_@astro
var page = () => netherlands_exports;
//#endregion
export { page };
