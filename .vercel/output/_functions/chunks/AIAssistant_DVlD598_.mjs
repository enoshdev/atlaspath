...
import { ArrowRight, MessageCircle, MessageSquare, RefreshCw, Send, Sparkles, X } from "lucide-react";
...
var WhatsAppButton = () => {
	...
	useEffect(() => {
		const checkChat = () => {
			...
			if (chatWidget) {
				...
				setChatOpen(!!chatWidget.querySelector("[class*=\"h-\\[480px\"]"));
			}
		};
	...
	return /* @__PURE__ */ jsxs("a", {
		...
		children: [/* @__PURE__ */ jsx("span", { className: "absolute inset-0 rounded-full bg-emerald-500/30 animate-ping group-hover:animate-none pointer-events-none" }), /* @__PURE__ */ jsx(MessageCircle, { className: "w-5 h-5 sm:w-6 sm:h-6 relative z-10" })]
	});
};
//#endregion
...
var AIAssistant = () => {
	...
	return /* @__PURE__ */ jsxs("div", {
		className: "fixed bottom-4 sm:bottom-6 right-3 sm:right-6 z-40",
		"data-chat-widget": true,
		children: [/* @__PURE__ */ jsx(AnimatePresence, { children: !isOpen && /* @__PURE__ */ jsxs(motion.button, {
			initial: {
				scale: .8,
				opacity: 0
			},
			...
			children: [/* @__PURE__ */ jsx("span", { className: "absolute inset-0 rounded-full bg-primary/20 animate-ping group-hover:animate-none pointer-events-none" }), /* @__PURE__ */ jsx(MessageSquare, { className: "w-5 h-5 sm:w-6 sm:h-6 relative z-10" })]
			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					className: "bg-[#090D1A] text-white p-3 sm:p-4 flex items-center justify-between shrink-0",
					children: [/* @__PURE__ */ jsxs("div", {
						className: "flex items-center gap-2.5",
						children: [/* @__PURE__ */ jsx("div", {
							className: "w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-primary flex items-center justify-center",
							children: /* @__PURE__ */ jsx(Sparkles, { className: "w-3.5 h-3.5 sm:w-4 sm:h-4" })
						}), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("span", {
							className: "text-[11px] sm:text-xs font-extrabold tracking-tight block",
							children: "Atlas AI"
						}), /* @__PURE__ */ jsx("span", {
							className: "text-[8px] sm:text-[9px] text-emerald-400 font-bold uppercase leading-none",
						...
						"aria-label": "Close",
						children: /* @__PURE__ */ jsx(X, { className: "w-3.5 h-3.5 sm:w-4 sm:h-4" })
					})]
				}),
				/* @__PURE__ */ jsxs("div", {
					ref: scrollRef,
					className: "flex-1 overflow-y-auto px-3 sm:px-4 py-3 sm:py-4 flex flex-col gap-3 bg-slate-50/50 scroll-smooth",
					children: [messages.map((msg, idx) => /* @__PURE__ */ jsxs("div", {
						className: `flex flex-col max-w-[88%] sm:max-w-[85%] ${msg.sender === "user" ? "self-end items-end" : "self-start items-start"}`,
						children: [/* @__PURE__ */ jsx("div", {
							className: `p-2.5 sm:p-3 text-[11px] sm:text-xs leading-relaxed rounded-xl sm:rounded-2xl ${msg.sender === "user" ? "bg-primary text-white rounded-tr-none" : "bg-white text-slate-800 border border-slate-100 shadow-sm rounded-tl-none"}`,
							children: msg.sender === "bot" ? formatText(msg.text) : msg.text
						}), /* @__PURE__ */ jsx("span", {
							className: "text-[7px] sm:text-[8px] text-slate-400 mt-1 px-1",
						...
						children: /* @__PURE__ */ jsxs("div", {
							className: "p-2.5 sm:p-3 bg-white text-slate-500 border border-slate-100 shadow-sm rounded-xl sm:rounded-2xl rounded-tl-none flex items-center gap-1.5",
							children: [/* @__PURE__ */ jsx(RefreshCw, { className: "w-3 h-3 sm:w-3.5 sm:h-3.5 animate-spin" }), /* @__PURE__ */ jsx("span", {
						...
						suggestions.length > 0 && !isTyping && /* @__PURE__ */ jsx("div", {
							...
							children: suggestions.map((s, i) => /* @__PURE__ */ jsxs("button", {
								...
								children: [
									s,
									" ",
									/* @__PURE__ */ jsx(ArrowRight, { className: "w-2 h-2 sm:w-2.5 sm:h-2.5 inline ml-0.5" })
								]
							}, i))
						}),
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("input", {
								...
								"aria-label": "Send",
								children: /* @__PURE__ */ jsx(Send, { className: "w-3 h-3 sm:w-3.5 sm:h-3.5" })
							})]
						}),
...
//#endregion
export { WhatsAppButton as n, AIAssistant as t };
