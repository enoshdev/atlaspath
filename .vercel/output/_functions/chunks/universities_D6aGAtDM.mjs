...
var UniversityExplorer = () => {
	...
	const toggleCourse = (c) => setSelectedCourses((prev) => prev.includes(c) ? prev.filter((x) => x !== c) : [...prev, c]);
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("aside", {
						...
						children: [
							...
							!showAllUnis && filteredUnis.length > 30 && displayedUnis.length > 0 && /* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsxs("button", {
									...
									children: ["Load More Universities", /* @__PURE__ */ jsx(ChevronDown, { className: "w-4 h-4" })]
								})
							}),
							/* @__PURE__ */ jsxs("div", {
								className: "mb-12",
